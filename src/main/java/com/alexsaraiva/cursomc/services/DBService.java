...
public class DBService {
	...
	public void InstantiateDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "nsd@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pswrd.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Joao da Costa", "ksjandjs@gmail.com", "31628382740", TipoCliente.PESSOA_FISICA, pswrd.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("93883321", "34252625"));
		cli2.addPerfilUsuario(PerfilUsuario.ADMIN);
