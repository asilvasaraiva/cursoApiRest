...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> deniedAuthorization(AuthorizationException e, HttpServletRequest request){
	...
	@ExceptionHandler(MyErrorTest.class)
	public ResponseEntity<?> myPersonalError(MyErrorTest e, HttpServletRequest request){
		StandardError err = new StandardError(HttpStatus.NOT_FOUND.value(), e.getMessage(), System.currentTimeMillis());
